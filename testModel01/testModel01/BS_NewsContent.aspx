...
<body>
    <form id="form1" runat="server">
        <div class="container">
            ...
            <asp:FormView ID="FormView1" runat="server" DataKeyNames="fId" DataSourceID="SqlDataSource1">
                <EditItemTemplate>
                    <table class="table">
                        <tr>
                        ...
                        <tr>
                            <td>
                                <asp:TextBox ID="fSubjectTextBox" runat="server" Text='<%# Bind("fSubject") %>' CssClass="form-control" Width="100%"/>
                            </td>
                        </tr>
                        <tr>
                            <td class="info text-center h4">
                                <asp:Label ID="Label4" runat="server" Text="內文"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <asp:TextBox ID="fContentTextBox" runat="server" Text='<%# Bind("fContent") %>' rows= "15" TextMode="MultiLine" CssClass="form-control" Width="100%" />
                            </td>
                        </tr>
                    </table>
                    <asp:LinkButton ID="UpdateButton" runat="server" CausesValidation="True" CommandName="Update" CssClass="btn btn-primary btn-sm" Text="更新" />
                    &nbsp;&nbsp;<asp:LinkButton ID="UpdateCancelButton" runat="server" CausesValidation="False" CommandName="Cancel" CssClass="btn btn-primary btn-sm" Text="取消" />
                    <br />
                ...
                <ItemTemplate>
                    <table class="table table-bordered table-condensed">
                        ...
                        <tr>
                            <td class="info text-center h4">
                                <asp:Label ID="Label2" runat="server" Text="內文"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td>
                    ...
                    <asp:LinkButton ID="EditButton" runat="server" CausesValidation="False" CommandName="Edit" Text="編輯消息" CssClass="btn btn-primary btn-sm" />
                    &nbsp;<asp:LinkButton ID="LinkButton1" runat="server" PostBackUrl="BS_NewsList.aspx">返回消息列表頁面</asp:LinkButton>

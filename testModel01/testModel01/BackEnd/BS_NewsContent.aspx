            ...
            <asp:DataList ID="DataList1" runat="server" DataKeyField="fId" DataSourceID="SqlDataSource2" OnEditCommand="DataList1_EditCommand" OnCancelCommand="DataList1_CancelCommand" OnUpdateCommand="DataList1_UpdateCommand" Width="100%">
                <ItemTemplate>
                    ...
                    <div class="modal-footer">
                        <asp:LinkButton ID="LinkButton3" runat="server" CommandName="Update" CssClass="btn btn-primary" OnClientClick="return confirm('確定要更新嗎?')">更新</asp:LinkButton>
                        <asp:LinkButton ID="LinkButton1" runat="server" CssClass="btn btn-primary" data-dismiss="modal">取消</asp:LinkButton>

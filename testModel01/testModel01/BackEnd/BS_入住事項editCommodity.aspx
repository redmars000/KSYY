<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BS_入住事項editCommodity.aspx.cs" Inherits="testModel01.BackEnd.BS_入住事項edit" ValidateRequest="false" %>
...
<body>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:dbKSYYConnectionString %>" DeleteCommand="DELETE FROM [tCommodity] WHERE [fId] = @fId" InsertCommand="INSERT INTO [tCommodity] ([fNo], [fContent], [fColor]) VALUES (@fNo, @fContent, @fColor)" SelectCommand="SELECT * FROM [tCommodity] WHERE ([fId] = @fId)" UpdateCommand="UPDATE [tCommodity] SET [fNo] = @fNo, [fContent] = @fContent, [fColor] = @fColor WHERE [fId] = @fId">
        <DeleteParameters>
            ...
            <EditItemTemplate>
                ...
                <div class="modal-header">
                    ...
                    <div class="modal-footer">
                        <asp:LinkButton ID="LinkButton1" runat="server" CssClass="btn btn-primary" CausesValidation="True" CommandName="Update" Text="更新" />
                        <asp:LinkButton ID="LinkButton2" runat="server" CssClass="btn btn-primary" CausesValidation="False" CommandName="Cancel" Text="取消" />
                    </div>             
            </EditItemTemplate>
            <InsertItemTemplate>
                fNo:

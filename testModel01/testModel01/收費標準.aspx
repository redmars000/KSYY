                        ...
                        <table style="background-color: #ff9933; border: 0; width: 99%;">
                            <tbody>
                                <tr style="background-color: #ff9900;">
                                    ...
                                    <td style="width: 36%">
                                        <div style="text-align: center; font-size: large; color: #000">基本月費<br />
                                            （含住房費、水電費、洗衣費、一般伙食費）</div>
                                    </td>
                                    <td style="width: 22%">
                                ...
                                <tr>
                                    ...
                                    <td style="background-color: #ffffcc; width: 20%">
                                        <div style="text-align: center; font-size: large; color: #000">1200~1600元/單趟<br />
                                            （含隨車人員）&nbsp;</div>
                                    </td>
                                </tr>
                                <tr>
